...
pub struct GPURenderer
{
    ...
    shadow_light_normals: OpenCLBuffer<Float3>,
    shadow_light_areas: OpenCLBuffer<f32>,
...
impl GPURenderer
{
    pub fn new(cl: &OpenCL) -> Self
    {
        ...
        let mut ray_brdfs: Vec<Float3> = Vec::with_capacity(num_rays);
        ...
        let mut shadow_light_normals: Vec<Float3> = Vec::with_capacity(num_rays);
        let mut shadow_light_areas: Vec<f32> = Vec::with_capacity(num_rays);
        ...
        let ray_brdfs = OpenCLBuffer::read_write(cl, ray_brdfs);
        ...
        let shadow_light_normals = OpenCLBuffer::read_write(cl, shadow_light_normals);
        let shadow_light_areas = OpenCLBuffer::read_write(cl, shadow_light_areas);
        ...
        shade_kernel.set_argument(10, &ray_brdfs);
        shade_kernel.set_argument(11, &shadow_ray_ts);
        shade_kernel.set_argument(12, &shadow_ray_origins);
        shade_kernel.set_argument(13, &shadow_ray_directions);
        shade_kernel.set_argument(14, &shadow_light_normals);
        shade_kernel.set_argument(15, &shadow_light_areas);
        shade_kernel.set_argument(16, &shadow_light_colors);

        connect_kernel.set_argument(0, num_rays as u32);
        connect_kernel.set_argument(1, &ray_colors);
        connect_kernel.set_argument(2, &ray_lights);
        connect_kernel.set_argument(3, &normals);
        connect_kernel.set_argument(4, &ray_brdfs);
        connect_kernel.set_argument(5, &shadow_ray_ts);
        connect_kernel.set_argument(6, &shadow_ray_origins);
        connect_kernel.set_argument(7, &shadow_ray_directions);
        connect_kernel.set_argument(8, &shadow_light_normals);
        connect_kernel.set_argument(9, &shadow_light_areas);
        connect_kernel.set_argument(10, &shadow_light_colors);
    ...
    pub fn set_scene(&mut self, scene: &GPUScene)
    {
        ...
        self.shade_kernel.set_argument(17, scene.quad_sizes.host_buffer.len() as u32);
        self.shade_kernel.set_argument(18, &scene.quad_sizes);
        self.shade_kernel.set_argument(19, &scene.quad_inv_transforms);
        self.shade_kernel.set_argument(20, &scene.quad_materials);

        self.connect_kernel.set_argument(11, scene.sphere_positions.host_buffer.len() as u32);
        self.connect_kernel.set_argument(12, &scene.sphere_positions);
        self.connect_kernel.set_argument(13, &scene.sphere_radi);
        self.connect_kernel.set_argument(14, scene.quad_sizes.host_buffer.len() as u32);
        self.connect_kernel.set_argument(15, &scene.quad_sizes);
        self.connect_kernel.set_argument(16, &scene.quad_inv_transforms);
        self.connect_kernel.set_argument(17, scene.mesh_offsets.host_buffer.len() as u32);
        self.connect_kernel.set_argument(18, &scene.mesh_offsets);
        self.connect_kernel.set_argument(19, &scene.mesh_triangle_offsets);
        self.connect_kernel.set_argument(20, &scene.mesh_inv_transforms);
        self.connect_kernel.set_argument(21, &scene.mesh_min_bounds);
        self.connect_kernel.set_argument(22, &scene.mesh_max_bounds);
        self.connect_kernel.set_argument(23, &scene.mesh_tri_counts);
        self.connect_kernel.set_argument(24, &scene.mesh_left_firsts);
        self.connect_kernel.set_argument(25, &scene.mesh_triangles);
    }
