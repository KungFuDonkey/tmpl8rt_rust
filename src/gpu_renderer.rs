...
impl GPURenderer
{
    pub fn new(cl: &OpenCL) -> Self
    {
        ...
        generate_rays_kernel.set_argument(9, &obj_ids);
        ...
        extend_kernel.set_argument(4, &obj_ids);
        ...
        shade_kernel.set_argument(4, &obj_ids);
        shade_kernel.set_argument(8, &accumulator);
    ...
    pub fn render(&mut self, cl: &OpenCL, scene: &GPUScene, camera: &Camera)
    {
        ...
        self.extend_kernel.set_argument(5, scene.sphere_positions.host_buffer.len() as u32);
        self.extend_kernel.set_argument(6, &scene.sphere_positions);
        self.extend_kernel.set_argument(7, &scene.sphere_radi2);
        self.extend_kernel.run(cl, self.num_rays);

        self.shade_kernel.set_argument(5, &scene.sphere_positions);
        self.shade_kernel.set_argument(6, &scene.sphere_radi2);
        self.shade_kernel.set_argument(7, &scene.sphere_inv_radi);
